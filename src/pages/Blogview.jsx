...
const EscortBlogViewPage = () => {
    ...
    // setTocItems(toc);
    const img = post._embedded?.["wp:featuredmedia"]?.[0]?.source_url ||"Not found";
        ...
        <section className="blog_dtls_page">
            <div className="container">
                ...
                <div className="col-md-9">
                    ...
                    <h1 plerdy-tracking-id={22817621801}>
                   {post.title.rendered}
                    </h1>
                    <ul className="publish">
                    <li plerdy-tracking-id={35635051201}>
                    <i className="fa fa-calendar" /> <strong> Posted On: </strong>{formattedDate}
                    </li>
                    <li plerdy-tracking-id={44876338201}>
                        <i className="fa fa-user" /> <strong>Posted By: </strong> Emily
                        Thompson
                    </li>
                    ...
                    <div className="top_doctor doc_info_area">
                        ...
                        <label plerdy-tracking-id={56188979501}> Content Writer</label>
                        <p>
                            Experienced Adult SEO content writer with 6 years in the
                            industry. Specializing in crafting compelling and optimized
                            content for the adult entertainment sector. Passionate about
                            creating engaging narratives and driving organic traffic through
                            strategic keyword integration. Ready to bring your adult website
                            or business to the forefront of search engine results.{" "}
                        </p>
                        </div>
                        </div>
                    </div>
            ...
            <div className="col-lg-10">
                ...
                <div className="row">
                    ...
                    <div className="quote-text">
                        ...
                        <p>Let us know what you need and we’ll find a solution.</p>
                    </div>
                    </div>
                    <div className="col-lg-4">
                    <div className="quote-action">
                        <p>
                        Request a quote within 15 minutes and get a FREE Marketing
                        Audit.
                        </p>
                        <a
                    ...
                    <div className="quote-timer" plerdy-tracking-id={14751649401}>
                        <div id="timer" className="row timer justify-content-center">
